...

{
    if((confirmPassword.value.trim()  !== '')){
        ...
        {after[3].innerHTML = "<p class = 'after-text-invalid'>Wrong Password</p><i class=\"fa fa-times\" aria-hidden=\"true\" style = \"color:red\"></i>";}
    }
        ...
        if(date.value.trim()!== '')
        {
            ...
            if(date_obj.length==3)
            {
                if(date_obj[0]<=currentYear && date_obj[1]<=12 && date_obj[2]<31){
                    ...
                    {after[4].innerHTML = "<p class = 'after-text-invalid'>Valid Age should be above 18</p><i class=\"fa fa-times\" aria-hidden=\"true\" style = \"color:red\"></i>";
